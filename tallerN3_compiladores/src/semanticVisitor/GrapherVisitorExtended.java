...
import ast.Var;
import visitor.*;
public class GrapherVisitorExtended implements visitor {
	...
	public void generarImagenGraph() throws Exception{
		try{
			BufferedWriter writer = new BufferedWriter(new FileWriter ("codSem.txt"));
		    ...
		    String fileInputPath = "C:/Users/JonathanDavis/Dropbox/Compiladores/proyecto taller 3/tallerN3_compiladores/codSem.txt";//txt del codigo .dot del arbol 
		    String fileOutputPath = "C:/Users/JonathanDavis/Dropbox/Compiladores/proyecto taller 3/tallerN3_compiladores/imgCodSemantico.png";//salida de imagen del codigo
		    String tParam = "-Tpng";
		    String tOParam = "-o";
	...
	public void visitar(AstVarDec astvarDec){
		...
		this.codigoGraph += astvarDec.toStringSemantico(this.auxPadres, this.cantNodosVisitados);
	...
	public void visitar(Var variable) {
		...
		if(variable.getExpresion()==null){
			...
			if(variable.isEsVar()){
				...
				ident=variable.toStringSemantico(this.cantNodosVisitados);
			}else{
				//el nodo contiene un numero.
				ident=variable.toStringNumSemantico(this.cantNodosVisitados);
			}
	...
	public void visitar(Expression ex) {
		...
		String ident=ex.toStringSemantico(this.cantNodosVisitados);
		this.codigoGraph+=ident;
		String[] delimitador=ident.split("\\[");
		String enlace=this.auxPadres.peek()+"->"+delimitador[0]+"; \n";
		this.codigoGraph+=enlace;
